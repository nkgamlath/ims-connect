  ...
  return (
    <nav
      ...
      <div className="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        {getGreetingMessage(auth.user.first_name)}
        <ul className="navbar-nav flex-row align-items-center ms-auto">
          <li className="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-end">
                ...
                <a aria-label='go to profile' className="dropdown-item" href="#">
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1">
                      <span className="fw-medium d-block">{auth.user.first_name} {auth.user.last_name}</span>
                      <small className="text-muted">{auth.user.role == 3 ? 'Admin' : (auth.user.role == 2)? "Innovation Manager": 'User'}</small>
                    </div>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a aria-label='click to log out' className="dropdown-item" href="#" onClick={handleClick}>
