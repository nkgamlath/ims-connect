    ...
    return (
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            <div className="app-brand demo">
                <Link aria-label='Navigate to ims homepage' to="/" className="app-brand-link">
                    <span className="app-brand-logo demo">
                        <img src="/assets/img/logo.svg" alt="ims-logo" aria-label='ims logo image' height={42}/>
                    </span>
                    <span className="app-brand-text demo menu-text fw-bold ms-2">ims-connect</span>
                </Link>
